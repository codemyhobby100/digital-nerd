  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] sm:w-[20rem] md:w-[30rem] bg-gradient-conic from-red-200 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
      >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-red-200 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-red-200 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-red-200"
        ></motion.div>
